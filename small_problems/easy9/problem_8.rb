...
# // input: two integers, first is count, second is the first number of the sequence
# // output: an array containing the sequence

# // array will contain the same number of elements as specified by the count
# // the values of these elements will be multiples of the starting number(second arg)
